...
author: Thomas Julou & Théo Gervais
...
In this project, we first analyse the [growth-coupled sensitivity of the *lac* operon of *E. coli* to TMG, in the presence or not of a transient growth arrest](GCS_MoM_lac_Transient_Arrest.html). The corresponding dataset contains the following experiments:
...
We next analyse the growth-coupled sensitivity of the *lac* operon to lactose when *E. coli* grows on mixtures of glucose and lactose, both [at the population level with different lactose concentrations](GCS_MoM_lac_SugarsMix.html) and [at the single-cell level for a given lactose concentration](GCS_MoM_lac_SugarsMix_realtrace.html). The corresponding dataset contains the following experiments:
